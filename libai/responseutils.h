#ifndef LIBAI_RESPONSEUTILS_H
#define LIBAI_RESPONSEUTILS_H
...
enum UtilityType {
    ...
    UtilityType_ReasoningInput,
    UtilityType_ReasoningOutput,
...
public:
    ...
    [[nodiscard]] bool operator<(const Empty&) const { return false; }
